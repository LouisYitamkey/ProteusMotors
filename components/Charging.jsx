    ...
    <section>
      <div className="relative items-center w-full px-5 md:py-12 mx-auto md:px-12 lg:px-20 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 pt-10 md:pt-0 col-span-2 gap-8 lg:grid-cols-3">
          <figure className='my-2 md:my-0 group'>
            <img className="w-full rounded-md bg-gray-200 transition-transform duration-300 transform-gpu group-hover:scale-105" src={firstImage} alt="" width="1310" height="873"/>
          ...
          <figure className='my-2 md:my-0 group'>
            <img className="w-full rounded-md text-[#1A1A1A] bg-gray-200 transition-transform duration-300 transform-gpu group-hover:scale-105" src={secondImage} alt="" width="1310" height="873"/>
          ...
          <figure className='my-2 md:my-0 group'>
            <img className="w-full rounded-md text-[#1A1A1A] bg-gray-200 transition-transform duration-300 transform-gpu group-hover:scale-105" src={thirdImage} alt="" width="1310" height="873"/>
