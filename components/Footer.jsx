    ...
    <div className={classes.footer}>
      ...
      <Group spacing="xs" position="center" noWrap>
          <ActionIcon size="lg" variant="default" radius="xl">
            <IconBrandTwitter className='text-blue-800' size="1.05rem" stroke={1.5} />
          </ActionIcon>
          <ActionIcon size="lg" variant="default" radius="xl">
            <IconBrandFacebook className='text-red-800' size="1.05rem" stroke={1.5} />
          </ActionIcon>
          <ActionIcon className='text-blue-500' size="lg" variant="default" radius="xl">
