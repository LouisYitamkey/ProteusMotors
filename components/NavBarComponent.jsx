    ...
    return (
      <Box>
        <Header height={90} className="md:px-52  px-3">
          <Group position="apart" sx={{ height: '100%' }}>
            ...
            <Group className={classes.hiddenMobile}>
              <button className='bg-black text-white px-6 py-3 hover:bg-slate-600 rounded-full'> Become a proteus champion</button>
            </Group>
        ...
        <Drawer
          ...
          size="100%"
          padding="md"
          title={   <img className="object-contain w-[124px]  h-[80px]" src={Logo} />}
          className={classes.hiddenDesktop}
          zIndex={1000000}
        >
          <Divider
